...
<!-- Main content -->
<section id="popular" class="content-background-white">
   <div class="container" >
      <div class="row">
         <!--
               ...
               <div class="modal-dialog" role="document">
                  <div class="modal-content">
                     ...
                     <div class="modal-body" style="background-color: #F2F2F2">
                        ...
                        <p><br><strong>Expiry Date</strong><br><i>Expiry date not available</i></p>
                        @else
                        <p><br><strong>Expiry Date</strong> <br>{{\Carbon\Carbon::parse($voucher->expiry_date)->format('d/m/Y')}}</p>
                        @endif
                        @if (!empty($voucher->website_link))
                        <a href="{{$voucher->website_link}}" target="_blank" style="color: #07AD4D;"><br><i class="fas fa-globe-americas"></i><strong> Visit Website</strong></a>
                        @endif
