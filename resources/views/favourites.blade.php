      ...
      <div class="card alignVoucherCards">
         <a href="#voucher{{$favouriteVoucher->id}}" role="button" data-toggle="modal">
            <div class="hoverOver" style="background-color: white; border: 1px solid #CCCCCC; text-align: center; ">
               <br>
               <img class="card-img-top" class="img-fluid" width="220" height="270" src="{{url('imgs/vouchers/' . $favouriteVoucher->image)}}" alt='{{$favouriteVoucher->name}}' onerror="this.onerror=null;this.src='imgs/no-voucher-image.png';">
         ...
         <div class="modal-dialog" role="document">
            <div class="modal-content">
               ...
               <div class="modal-body text-center">
                  <img id="modal_image_{{$favouriteVoucher->id}}" src="{{url('imgs/vouchers/' . $favouriteVoucher->image)}}" class="img-fluid img-center modal-image" alt='{{$favouriteVoucher->name}}' onerror="this.onerror=null;this.src='imgs/no-voucher-image.png';">
                  ...
                  @else
                  <div id="redeem-current-{{$favouriteVoucher->id}}" class="redeem-overlay redeem-overlay-current" style="display:none">
                     ...
                     <p class="text-center" style="margin-bottom:0px;">Voucher next available at <strong><span id="redeem-next-time-{{$favouriteVoucher->id}}"></span></strong></p>
                  </div>
                  @endif     
                  @auth
                  <p class="text-center"><span id="time{{$favouriteVoucher->id}}" style="color:#A61106; font-size:18px;"></span><br></p>
