                  ...
                  <table class="table table-hover">
                     <tbody>
                        ...
                        <tr v-for="business in businesses.data" :key="business.created_at">
                           ...
                           <td>
                              <a href="#" @click="editBusinessModal(business)"> <i class="far fas fa-pencil-alt"  style="color: #FFC107;"></i></a>
                              <a href="#" @click="deleteBusiness(business.id, business.name)"><i class="fas fa-trash red"></i></a>
                           </td>
                        </tr>
                     </tbody>
                  </table>
